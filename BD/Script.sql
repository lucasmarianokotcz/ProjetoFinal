...
CREATE TABLE cabecalho (
  ...
  IMAGEM_CABECALHO VARBINARY(MAX) NULL,
  COD_USUARIO INT NOT NULL FOREIGN KEY REFERENCES usuario(COD_USUARIO),
  COD_COLEGIO INT NOT NULL FOREIGN KEY REFERENCES colegio(COD_COLEGIO),
  COD_TURMA INT NOT NULL FOREIGN KEY REFERENCES turma(COD_TURMA)
);
...
CREATE TABLE questao (
  ...
  NUMERO_LINHAS TINYINT NULL,
  COD_MATERIA INT NOT NULL FOREIGN KEY REFERENCES materia(COD_MATERIA),
  COD_PROVA INT NOT NULL FOREIGN KEY REFERENCES cabecalho(COD_PROVA),
  COD_ASSUNTO INT NOT NULL FOREIGN KEY REFERENCES assunto(COD_ASSUNTO)
);
